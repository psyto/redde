...
import { selector, storageKey } from "./keccak.mjs"; // single audited keccak256 (self-tests on import)
...
// keccak256 / selector / storageKey now come from ./keccak.mjs (single audited source).
